...
def compute_feature_distances(
    ...
    (n2,feat_dim) = features2.shape
    dists = [np.sqrt(((features2 - feature1)**2).sum(axis=1)) for feature1 in features1]
...
def match_features_ratio_test(
    ...
    # consider this: 'matches' and 'confidences' can be empty, e.g., (0x2) and (0x1)
